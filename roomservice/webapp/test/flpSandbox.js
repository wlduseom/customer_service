		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Room Service",
									"targetURL": "#syncc201roomservice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc201roomservice-display": {
								"semanticObject": "syncc201roomservice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c201.roomservice",
									"url": sap.ui.require.toUrl("sync/c201/roomservice")
								}
							}
						}
					}
